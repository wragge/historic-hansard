...
debates:
  ...
  - title: "QUESTION"
    ...
    type: questions
    subdebates:
      - title: "RELIEF TO THECROTTY MINERS"
        id: "#subdebate-1-0"
  - title: "QUESTION"
    id: "#debate-2"
    type: questions
    subdebates:
      - title: "FEDERAL ELECTORAL ROLLS"
        id: "#subdebate-2-0"
  - title: "QUESTION"
    id: "#debate-3"
    type: questions
  ...
  - title: "QUESTION"
    ...
    type: questions
    subdebates:
      - title: "PERMANENT STANDING ORDERS"
        id: "#subdebate-5-0"
  - title: "QUESTION"
    id: "#debate-6"
    type: questions
  ...
  - title: "MESSAGES"
    ...
    type: miscellaneous
    subdebates:
  - title: "PRINTING, LIBRARY, AND HOUSE COMMITTEES"
    id: "#debate-10"
    type: miscellaneous
    subdebates:
...
* [QUESTION](#debate-1)
    * [RELIEF TO THECROTTY MINERS](#subdebate-1-0)
* [QUESTION](#debate-2)
    * [FEDERAL ELECTORAL ROLLS](#subdebate-2-0)
* [QUESTION](#debate-3)
    * [GENERAL ELECTIONS](#subdebate-3-0)
* [QUESTION](#debate-4)
    * [ELECTORAL ACT AMENDMENT](#subdebate-4-0)
* [QUESTION](#debate-5)
    * [PERMANENT STANDING ORDERS](#subdebate-5-0)
* [QUESTION](#debate-6)
    * [COMMONWEALTH POSTAGE STAMP](#subdebate-6-0)
* [QUESTION](#debate-7)
    * [RIFLE CLUB REGULATIONS](#subdebate-7-0)
* [QUESTION](#debate-8)
    * [GOVERNOR-GENERAL'S SPEECH : ADDRESS IN REPLY](#subdebate-8-0)
* [MESSAGES](#debate-9)
* [PRINTING, LIBRARY, AND HOUSE COMMITTEES](#debate-10)
* [HOUSE COMMITTEE](#debate-11)
* [HIGH COURT PROCEDURE BILL](#debate-12)
* [SPECIAL ADJOURNMENT](#debate-13)
    * [Barton) -](#subdebate-13-0)
...
{: type="1" start="2"}
0. If so, what is the result of such deliberations. 
1. If not, will lie consider the matter us soon, as possible. 

Sin EDMUND BARTON.- The answers to the honorable member's questions are as follow :  - 

{: type="1" start="1"}
0. Yes, so far as the Commonwealth postage stamp can be made uniform during the book keeping period. (2&amp;3) A decision will shortly be arrived at and made public. 
...
{: type="1" start="1"}
0. When the new regulations re rifle clubs are likely to be issued ? 
1. Whether any of the new rifles are to be issued to rifle clubs ? 
2. Whether it is his intention to increase the price of ammunition to members of rifle clubs ? 
3. Why it is that requisitions for passes over Queensland railways may not be signed by the nearest Defence Force officer, as was the case prior to federation ? 
...
{: type="1" start="1"}
0. .  At an early date. 
1. Yes, when available. 
2. Not at present. 
3. Inquiry is being made into the matter. 
...
{: type="1" start="1"}
0. "That while the company's stocks were charged excise, the stocks of susrar in breweries and other excise factories mentioned in the Excise Act were not charged excise." 
...
<graphic href="013331190306033_24_0.jpg"></graphic>
...
{: type="1" start="1"}
0. Whether it is true, as alleged by the Colonial Sugar Befining Company, that no excise duty was levied on large quantities of sugar in stock, enstody, or possession of, or belonging to, the manufacturers thereof, and stored in their premises at Bundaberg and Brisbane, on the Sth October last, while the sugar in the possession of the said company was made liable to the excise duty paid on the above date. 
1. If so, what was the reason for such differential treatment. 
...
{: type="1" start="2"}
0. "That a largo quantity of sugar, amounting to over 9,000 tons, thB property of Millaquin and Yengarie Sugar Company, and other ' white ' sugars owned by Gibson and Howes, A. H. and E. Young, the Nerang Central Mill, and Wood Bros, and Boyd, all the time in their stock, custody, and possession, on the introduction of the Tariff, was not charged excise, but was delivered free." 
...
<graphic href="013331190306033_26_1.jpg"></graphic>
...
{: type="A" start="I"}
0. specially refer to the gentleman who introduced the deputation, because I feel sure that he is absolutely public spirited. It is very pleasant to have to do with a gentleman who not only speaks boldly, but gives every assistance to the Customs. It cannot be doubted that the members of the deputation were in a position to know what was going on, and to give reliable information. Some honorable member asked me a question regarding this matter, which was also mentioned in the Queensland Parliament in the following manner :  - 


 **Mr. Macartney** asked the Treasurer 

{: type="A" start="J"}
0. Has he seen a statement referring to an alleged leakage in Customs revenue attributed to  **Mr. Alexander**  Stewart (of Messrs. Stewart and Hemmant) ? 

    {: type="1" start="2"}
    0. Is there, in his opinion, any foundation for such statement in fact ? 
    1. Has any action been taken in the matter?  **Mr. Cribb**  replied : - 1. Yes. 2. Yes. 3. The alleged leakage in Customs revenue was brought under the notice of the Treasurer on 7th June last. Steps are being taken to prevent such leakage. 
...
{: type="1" start="1"}
0. As to entries, I do not wish prosecutionswhen the nature and value of the goods are fairly disclosed in the entry, so that acceptance of the- entry will not necessarily cause loss to the revenue - if the officer does his duty. 
1. I specially desire that no errorof classification by the importer in the entry shall alone render him liable to penal consequence if he has in the entry disclosed the true nature of the goods so that they can well be identified for Tariff purposes by an officer familiar with the Tariff'. 
...
{:#debate-10}
### PRINTING, LIBRARY, AND HOUSE COMMITTEES
