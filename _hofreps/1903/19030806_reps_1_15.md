...
0. In time of war it shall be lawful for the Governor-General (the occasion being first communicated to the Parliament, if the Parliament be then sitting, or notified by proclamation if the Parliament be not then sitting), by proclamation, to call upon persons liable to serve in the Militia Forces to enlist in the Militia Forces, 
    ...
    {: type="1" start="3"}
    0. The classes referred to in this section are as follows :  - 
    1. A proclamation under this section may - 

    {: type="a" start="a"}
    0. Call upon all persons liable to serve in the Militia Forces to enlist in those forces. 
...
{: type="1" start="1"}
0. The Governor-General may, by proclamation, declare what persons shall be exempt from service in the Defence Force. 
1. The barden of proving exemption from service in the Defence Force shall rest on the person claiming exemption. 
...
{: type="1" start="1"}
0. The following persons shall be exempt from service in the Defence Force :  - 
