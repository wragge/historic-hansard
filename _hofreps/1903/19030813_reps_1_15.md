...
{: type="a" start="a"}
0. That the statistics as to the number of elec tors residing in the country are unreliable. 
1. That, owing to the drought, numbers of electors from country districts have moved - probably only temporarily - to the metropolitan centres. 
2. That a very large proportion of persons entitled who have been accidentally omitted from the returns are country residents, and that the number so omitted is almost great enough to form a quota for a division. 
