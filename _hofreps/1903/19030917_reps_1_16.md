...
{:#subdebate-7-1}
#### Division 101 (General Contingencies), £10,660
...
{:#subdebate-8-0}
#### Division 174 (Central Staff), £5,347
...
{: type="a" start="a"}
0. whose father, or whose mother, has ob tained a certificate of naturalization ; or 
...
{: type="1" start="1"}
0. That it is impossible to say from a written document whether the invention described in it is novel or not. For instance, in Germany patents were refused for the Bessemer steel process, and the  Siemen's  Regenerative Furnace, as not being novel. 
...
{: type="1" start="2"}
0. That it is impossible for an examiner, however competent, to know whether an alleged invention is novel or not. 
1. That it is unjust in the granting of patents to rely on the judgment or opinion of one individual. 
2. That it gives rise to an erroneous belief in the minds of people that the Crown guarantees the validity of the patent. 
...
{: type="1" start="5"}
0. That  under the system  patents  are arbitrarily  refused for useful and meritorious inventions. 
