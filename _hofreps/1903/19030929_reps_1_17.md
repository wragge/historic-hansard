...
{: type="a" start="e"}
0. Delegate any of his powers under this Act " to a Deputy Commissioner. 
...
{: type="1" start="3"}
0. Any of the following persons may make application for a patent : - 

    {: type="a" start="a"}
    0. The actual inventor, or 

    {: type="1" start="6"}
    0. his assignee or nominee . . . 
