...
{: type="A" start="I"}
0. think, that any one who intended fairly to represent me could not have mistaken , the views I expressed in that speech. I merely use these quotations in order to show whether now, or in the future, any reliance can be placed on the word of the honorable member for Echuca. 
