...
{:#debate-13}
### SUPPLY. ADDITIONS, NEW WORKS, AND BUILDINGS
...
{: type="a" start="a"}
0. to pay to the workmen and employes employed in the manufacture of the goods the rate of wages fixed as hereinafter provided, or, if no rate is so fixed, the highest wages usually paid in the State to workmen and employes doing' similar work ; and 
