...
##### Mr WILSON:<br><small class="text-muted">for Mr. Robinson</small>
...
{: type="1" start="1"}
0. Any manufactured or prepared article of food - 

    {: type="a" start="a"}
    0. to which there is not applied a printed mark indicating its usual name ; or 
    1. to which there is added any other substance not necessary to its preparation (including colouring matter or preserva tives) unless there is applied to it a printed mark indicating the substance so added ; or 
    2. from which there is abstracted any material part or ingredient the abstraction of which is not necessary or usual in preparing the article or affects injuriously its quality, substance, or nature - unless there is applied to it a printed mark indicating the part or ingredient so abstracted ; or 
    3. in which (in the case of an article usually sweetened with sugar) there is contained any sweetening substance in addition to or in lieu of sugar - unless there is applied to it a printed mark indicating the sweetening substance so contained, is prohibited to be imported into Australia. 

1. In this section - 

    {: type="a" start="a"}
    0. 
 *"* Food " includes any article used for food or drink by man other than drugs or water; 
    1. "Indicating" means plainly and legibly indicating ; 
    2. in the case of goods made up into packages for sale by retail, " applied " means applied to every such package in the same manner and with the same permanency as other printed marks or indications of the goods. 

2. All goods imported in contravention of this section shall be forfeited to the King. 
...
<graphic href="027331190509210_42_0_1_A.jpg"></graphic>



<graphic href="027331190509210_42_0_2_N.jpg"></graphic>



<graphic href="027331190509210_42_0_3_P.jpg"></graphic>
