...
page_start: 4511
parliament: 2
file_id: 19051102_reps_2_28
debates:
  - title: "QUESTION"
    id: "#debate-0"
    type: questions
    subdebates:
      - title: "REMUNERATION OF MEMBERS"
        id: "#subdebate-0-0"
  - title: "PRINTING COMMITTEE"
    id: "#debate-1"
    type: miscellaneous
    subdebates:
      - title: "Distributionof Papers"
        id: "#subdebate-1-0"
  ...
  - title: "QUESTION"
    ...
    type: questions
    subdebates:
      - title: "SOUTH AUSTRALIAN MILITARY INSTRUCTIONAL STAFF"
        id: "#subdebate-4-0"
  - title: "QUESTION"
    id: "#debate-5"
    type: questions
    subdebates:
      - title: "RIFLES : DEFENCE DEPARTMENT"
        id: "#subdebate-5-0"
  - title: "QUESTION"
    id: "#debate-6"
    type: questions
    subdebates:
      - title: "SALE OF WARSHIPS"
        id: "#subdebate-6-0"
  - title: "QUESTION"
    id: "#debate-7"
    type: questions
    subdebates:
      - title: "PENNY POSTAGE"
        id: "#subdebate-7-0"
  - title: "COST OF HOBART CONFERENCE"
    id: "#debate-8"
    type: miscellaneous
    subdebates:
  - title: "QUESTION"
    ...
    type: questions
    subdebates:
      - title: "TELEPHONES AND TELEGRAPHS IN COUNTRY DISTRICTS: GUARANTEES"
        id: "#subdebate-9-0"
  - title: "QUESTION"
    id: "#debate-10"
    type: questions
  ...
  - title: "ADJOURNMENT"
    ...
    type: adjournment
    subdebates:
      - title: "Federal Capital. - Order of Business"
        id: "#subdebate-16-0"
---

* [QUESTION](#debate-0)
    * [REMUNERATION OF MEMBERS](#subdebate-0-0)
* [PRINTING COMMITTEE](#debate-1)
    * [Distributionof Papers](#subdebate-1-0)
* [SUGAR BOUNTY BILL](#debate-2)
* [QUESTION](#debate-3)
    * [ALIEN IMMIGRATION](#subdebate-3-0)
* [QUESTION](#debate-4)
    * [SOUTH AUSTRALIAN MILITARY INSTRUCTIONAL STAFF](#subdebate-4-0)
* [QUESTION](#debate-5)
    * [RIFLES : DEFENCE DEPARTMENT](#subdebate-5-0)
* [QUESTION](#debate-6)
    * [SALE OF WARSHIPS](#subdebate-6-0)
* [QUESTION](#debate-7)
    * [PENNY POSTAGE](#subdebate-7-0)
* [COST OF HOBART CONFERENCE](#debate-8)
* [QUESTION](#debate-9)
    * [TELEPHONES AND TELEGRAPHS IN COUNTRY DISTRICTS: GUARANTEES](#subdebate-9-0)
* [QUESTION](#debate-10)
    * [PENNY POSTAGE](#subdebate-10-0)
* [QUESTION](#debate-11)
    * [ELECTIVE MINISTRIES](#subdebate-11-0)
* [ELECTORAL BILL 1905](#debate-12)
* [ESTIMATES](#debate-13)
    * [Department of External Affairs](#subdebate-13-0)
    * [Attorney-General's Department](#subdebate-13-2)
* [REPRESENTATION BILL](#debate-14)
* [LIFE ASSURANCE COMPANIES BILL](#debate-15)
* [ADJOURNMENT](#debate-16)
    * [Federal Capital. - Order of Business](#subdebate-16-0)
...
{: type="1" start="1"}
0. The number of officers holding appointments on the Instructional Staff of the South Australian Military Forces? 
1. The number of officers appointed to the Instructional Staff since1st July, 1903? 
2. The number of officers who have passed the educational qualifying examination? 
3. The number of officers who have passed the military competitive examination? 
4. Will those officers who have not qualified in the educational and military competitive examinations' be candidates at the examination to be held during the week ending 16th December next? 
...
{: type="1" start="1"}
0. Two. 
1. For the Commonwealth, two; for South Australia, none. 
2. None. 
3. None. 
4. No.The Minister further states in explanation that no examination for such appointments has been held since1st July, 1903. Of the two officers appointed since that date, Captain Robertson passed the examination in military subjects on the completion of his term of probation, and 
...
{: type="1" start="1"}
0. What are the standard rifles adopted by the Defence Department for the equipment of rifle clubs and defence purposes generally? 
1. Is it a fact that rifle clubs are loaned MartiniEnfield rifles at the rate of one rifle for each two active members or one Lee-Enfield magazine rifle for each ten members, and, if so, why this difference ? 
2. Are both these rifles considered equally suitable for rifle club and defence purposes? 
3. Is it proposed to supply all members of rifle clubs with latest standard pattern of rifles, and, if so, when is it expected that clubs will be so equipped ? 
...
{: type="1" start="1"}
0. The. Defence Department does not equip rifle clubs with rifles, but clubs may procure a number of Martini-Enfield and magazine LeeEnfield rifles from the Department on loan or by purchase. For military purposes, the standard rifles are - Magazine Lee-Enfield, long for infantry, short for light horse. 
1. There are no particular proportionslaid down in the case of the loan of Martini-Enfield rifles. The loan issue of magazine Lee-Enfield rifles is at the rate of ten per cent. of the active members. 
...
{: type="1" start="3"}
0. For rifle club practice they are both equally good; for military purposes, the magazine LeeEnfield is superior. 
1. It is not proposed to alter the practice just at present, but members of rifle clubs are afforded facilities for buying rifles on deferred payment from the Department. 
...
{: type="1" start="1"}
0. Asking for protection for the miners on the Mambare and Ikora Rivers from the depredations of hostile natives. The deputation pointed out that there was no protection available at present. 
1. Requesting the imposition of a hut tax on coastal natives. The deputation suggested that 5s. per head, to be paid either in kind, labour, or cash, be imposed. 
2. 
 *Re* Papuan mail service. - The deputation suggested that either Cooktown or Cairns be appointed the terminal port in Australia, instead of Thursday Island as at present. 4.Re the Steve Wool ffe murder case, and asking that it be reopened. It was stated by the deputation that Woolffe was a minor on the Ikora River, who had recently been sentenced to death for the alleged shooting of a native. The sentence was subsequently commuted to imprisonment for three years. It was explained that the prisoner was the first white man ever sentenced to death in British New Guinea. The only evidence against him was that of natives. 
3. Trial by jury was asked for. The deputation explained that at present all cases are tried by the Judge solely. 
...
{:#subdebate-16-0}
#### Federal Capital. - Order of Business
