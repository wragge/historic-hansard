...
{: type="1" start="1"}
0. When a person claiming to be the proprietor of several trade marks, which while resembling each other in the essential particulars thereof yet differ in respect of - 

    {: type="a" start="a"}
    0. statements of the goods for which they are respectively used or proposed to be used, or 
    1. statements of number, price, quality, or names of places, seeks to register such trade marks, they may be registered as a series in one registration. 
