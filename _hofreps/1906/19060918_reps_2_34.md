...
{: type="A" start="I"}
0. . think, is some room for objection. Some four years ago, an understanding was arrived at that the expenditure on the military side should be cut down to a certain amount, which it is now proposed to exceed by £80,000. As against that possible saving, however, there is the fact that we should spend a large additional sum upon our coastal defences. Unless we do so, we cannot be said to have adequately provided for the proper defence of Australia. We should take some action in the direction of providing a mosquito fleet for the defence of our ports. If we make a saving upon the military side, it will be necessary for us to spend as large a sum, if not even more, upon coastal defences, and, therefore, we cannot look for any economy in that direction. When we analyze the figures representing the increases in the Departments, it is difficult to put a finger upon any one item and say that it should be cut down. 
...
{:#subdebate-13-0}
#### Luncheon and Dinner Adjournments
