...
##### Mr WILSON:<br><small class="text-muted">Corangaimite</small>
...
{: type="1" start="1"}
0. Every sort of rag of whatever material, a. Every sort of clothes which have been worn, and other susceptible effects, which do not belong to persons who have entered quarantine with them, and whose origin is not well known. 
1. All effects which are known to have belonged to persons who have died in the Levant, although not of the plague. 
2. Clothes, and other effects, in use by persons who are sick or have died of the plague. 
...
{: type="1" start="3"}
0. The powers conferred on the GovernorGeneral by this section, in relation to the matters specified in paragraphs  *(g), (h),*  and  *(i)*  of subsection (r), so far as they relate to animals or plants or any disease or pest affecting animals or plants, shall, as regards a State or part of a State, only be exercised in cases where the GovernorGeneral is satisfied that the exercise of those powers is necessary for the purpose of preventing the spread of a disease or pest affecting animals or plants, beyond the boundaries of that State. 
