...
##### Mr BRUCE1 SMITH:<br><small class="text-muted">PARKES, NEW SOUTH WALES</small>
...
{: type="1" start="1"}
0. From  1910  until 1Q20, and thereafter until Parliament otherwise provides, the States to receive a fixed' annual, sum. based on the average of three-fourths of the net Customs and Excise, revenue during certain years.- (a). The States to receive, a payment in addition to such fixed amount to bring the aggregate payment to the .States up to three-fourths of the new Customs and Excise Revenue, such additional payment to be distributed  *fer*  *capita*  (3). The' Commonwealth to. have the. right to impose new duties for specific purposes, both on items at present subject to duty, and also on items at present not subject to duty - the Commonwealth Treasurer to retain the whole of the revenue raised thereby. 
