...
{: type="1" start="1"}
0. .  That, with a view to protecting the consumer, a permanent commission be created to inquire into and report upon the prices charged for locally produced goods, having regard to the cost of raw materials, wages paid, hours worked by employes, rate of import duty and other essential factors. 
1. That such commission be empowered to use the resources of the Statistician's office and the Customs department to facilitate its inquiries, and be also authorized to employ expert officers to prosecute special investigations. 
2. That, in the event of such commission re porting that unfairly high prices are being charged in respect of goods the product of aprotected industry and recommending the reduction of the import duty, the Governor-General may, on resolution of both Houses, reduce the duty to the extent recommended. 
...
##### Mr Mauger:<br><small class="text-muted">General &middot; Postmaster &middot; Protectionist</small>
...
{: type="A" start="E"}
0. What competition have you to meet from abroad ? 
1. What are the wages and hours of employes in countries with whom  you  have to compete? 
2. What is the value of  imports  of goods which you could manufacture? 
3. Could you say what- employment would be given and wages paid if the imports referred to were manufactured . in Australia? 
