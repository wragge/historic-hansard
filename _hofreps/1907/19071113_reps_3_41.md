...
{: type="a" start="a"}
0. Gloves made from kid (General Tariff), 30 per cent. ; (United Kingdom), 20 per cent. 

    {: type="A" start="B"}
    0. Gloves n.e.i. of all kinds and materials, including mittens (General Tariff), 15 per cent. ; (United Kingdom), 10 per cent. 
...
{: type="a" start="a"}
0. Of all descriptions and materials, n.e.i., including Forms and Pull-over Hoods and Shapes, and Frames n.e.i., ad val. (General Tariff), 35 per cent. ; (United Kingdom), 30 per cent. 

    {: type="A" start="B"}
    0. Firemen's Helmets, and Miners' Hats, free. 
...
{: type="a" start="a"}
0. Wool Felt Hats, in any stage of manufacture, per dozen (General Tariff), 16s. ; (United Kingdom), 12s. 
1. Fur Felt Hats, in any stage of manufacture, per dozen (General Tariff), 25s. ; (United Kingdom), 20s. 

    {: type="A" start="C"}
    0. Firemen's Helmets and Miners' Hats, free. 

2. Hats, Caps, and Bonnets of all descriptions and materials, n.e.i., including Forms, Pullover Hoods, Shapes, and Frames, n.e.i., ad val. (General Tariff), 35 per cent. ; (United Kingdom), 30 per cent. 
