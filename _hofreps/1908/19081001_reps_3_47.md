...
1. That the following be the method of selection of the site, and that so much of the Standing Orders be suspended as would prevent the House from adopting such method :  - 
...
4. If, on the first examination, any site proves to have received nn absolute majority of votes, the  Speaker  shall report the name of such site to the House, and such site shall be deemed to be the one preferred by honorable members. 
