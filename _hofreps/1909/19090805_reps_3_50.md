...
{: type="1" start="1"}
0. Has his attention been directed to complaints in New South Wales that, under Commonwealth administration, recipients of old-age pensions are, in any number of cases, having reductions made on the amount allotted them as compared with their allowances under State legislation and administration? 
1. What is the reason for such general reduction of payments? 
2. Does he propose to see that the scale of payments made under State administration shall be accepted by the Commonwealth, excepting in cases where reductions would have been made by the State? 
...
{: type="1" start="1"}
0. Yes, in some cases. 
1. The reason is that deductions from pension on account of property are larger under the Commonwealth Act. Under the New South Wales Act a deduction of , £1 is made for every £15 of property above £50. Under the Commonwealth Act a deduction of , £1 is made for every £10 of property above £50. Under the Commonwealth Act the deduction on account of property is made in respect only of property over ; £100 in value, if the property includes a home. 
2. This cannot be done under the Act. 
...
{: type="1" start="1"}
0. Whether he has considered the general effect of the judgment of the High Court in the case of  *Huddart Parker*  v.  *Moorekead,*  in its relation to the powers of the Commonwealth under section 51 of the Constitution? 
1. If so, does he consider that the powers there enumerated are to be read with an implied reservation against Intra-State operations? 
...
{: type="1" start="1"}
0. Yes. 
1. I do not think that the judgment lays down any such doctrine. The principle enunciated appears to be that the express limitation of the commerce power of the Federal Parliament to Inter-State and external commerce implies a reservation to the States of the sphere of domestic commerce, except so far as that sphere comes within the jurisdiction of the Commonwealth by virtue of some other head of legislative power. 
