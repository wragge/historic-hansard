...
0. The affairs of the association shall be regulated by rules specifying the purposes for which it is formed, and providing for the following matters in relation to the association :  - 
    ...
    {: type="a" start="h"}
    0. The mode in which the property is to be controlled and the funds invested ; 
    1. The yearly or other more frequent audit of the accounts; 
    2. The conditions under which funds may be disbursed for ordinary and extraordinary purposes. 
