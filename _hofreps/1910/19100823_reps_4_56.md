...
6. The number of rifles required depends upon the number of men who are trained and organized as Defence Forces, together with those who have passed through such Forces during the last few years. 
...
-This is a serious question, and I Hope the honorable member will treat it seriously. The point I wish to establish is that under present conditions the banks are making no profit out of their note issue. The State is now going to take over the work, and we are told that it is going to set up a gold reserve of 25 per cent. Thus, with an issue of £4,000,000, the State will keep £1,000,000 in cash, leaving a balance of £3,000,000. What we have now to consider is how the issuing of these Commonwealth notes will compare with a straightout loan from the British people. Assuming that the Commonwealth would have to PaY  *3h*  Per cent- f°r a l°an, although I do not believe that it would, it would thus be called upon to pay £105,000 a year for a loan of £3,000,000. It would have to retain ,£1,000,000 in order to fulfil its undertaking to have a gold reserve of 25 per cent., and it would have to go to the world's market to borrow £3,000,000, on which it would have to pay £105,000 a year,, at the rate of 3  *\*  per cent., to the British people. Then, to get at the actual gain to the people, let us begin by remembering that the Commonwealth is going to deprive the Australian people of £80,000 per annum that is now derived from the State bank note tax. Honorable members may say, ' ' That £80,000 was paid to the States, but this money will be gained by the Commonwealth." I would remind them, however, that in both cases the people are the same. This issue is for "the benefit of the people of Australia, and if we deprive the people of Australia of the revenue of £80,000 a year now received from the bank note tax, we must deduct that £80,000 from the £105,000 to which I have referred. That leaves us with a profit of £25,000. There is yet, however, another charge. The Commonwealth will have to issue its own notes up to £4,000,000. Assuming that that will only cost the Government what it costs the banks- - 
...
{: type="1" start="1"}
0. Commissions to be appointed sufficiently large to adequately represent Government and banks, for purpose of managing and regulating the note issues of the Colonies; banks to give up existing issuing powers in consideration of certain benefits hereafter specified. 
1. Such Commissions to be empowered to issue in first instance notes equal to the existing circulation and supply till money for meeting the ordinary demands of the public. 
2. The banks on application, on providing coin for the same, to receive notes in proportions based on the existing note issues and the total assets and liabilities in each respective Colony. 
3. These notes to be used :  - (a) To retire existing circulation ; (b) till money, and a register to be kept, showing amount each bank is entitled to out of total authorized issue, and amount at which till money is estimated. 
4. The amount provided by the banks should, in the opinion of this Conference, be applied thus :  - 25 to 30 per cent, kept in gold ; balance invested in funded stock of the Colonies embracing the scheme. 
