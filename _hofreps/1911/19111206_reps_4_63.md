...
{: type="a" start="a"}
0. on behalf of, or in the interests of, any candidate, or 
1. on behalf of, or in the interests of, any political party, shall in accordance with this section make a return of the money so expended or expense so incurred. 
...
{: type="1" start="1"}
0. 
 *Tasmania.* - A new Act was passed in 1907 applying proportional representation throughout the Colony. The new Act will beused in the State elections for 1909 and will be used in the following year for the. Commonwealth elections in Tasmania. 
1. 
 *South Africa.* - The draft Constitution approved by the National Convention provides for proportional representation in all elections. 
2. 
 *South Australia.-A* Proportional Representation Bill is at present under consideration, and an active propaganda is being carried on by the veteran Miss Spence. 
3. 
 *Oregon.* - The Constitutional amendment authorizing the introduction of proportional representation was submitted to the popular vote on the rst of June, 1908, and carried by a large majority. 
4. 
 *Switzerland.* - The Canton of Ticino adopted the system in1890, and has been followed by Neuchatel, Geneva, Solothurn, Zug, Schwyz, and Basle City, and also (for municipal elections) by Berne, Fribourg, and the Valais. The movement continues to spread. 
5. 
 *Belgium.* -In 1895, proportional representation was introduced into the elections for the councils of the larger municipalities, and, in 1899, after several years' effort on the part  of  the Belgian Society, the law applying the reform to parliamentary elections was adopted, a law which has given general satisfaction. 
6. 
 *France.* - Encouraged by the success of. the 
...
{: type="1" start="8"}
0. 
 *Finland.* - A system of proportional "representation was adopted in 1906. Two general elections have since been held and, in each case, there was but a very small percentage of spoiled ballot-papers. 
1. 
 *Sweden.* - In February; 1909, both Chambers of the Riksdag finally approved by large majorities the adoption of an electoral reform establishing proportional, representation. These measures had already received the approbation of the previous Parliament. 
2. 
 *W urt ember g* adopted a system of proportional representation in 1906: Of the first elections  *Der Beobachter,*  a leading journal of Stuttgart, reported : . " The new electoral system, which only a short time ago was unknown to the electors, worked without a hitch in the whole country, just as it worked a few weeks ago in Stuttgart. The first feeling is one of surprise. The number of votes was enormous ; the candidates were numerous and the ballot-papers from the different districts were in various forms, and vet the whole machine, from the district officials to the employees of the government offices, who collected the results, worked with promptitude and ease. The next feeling is one of pleasure at the complete success of this first experiment in proportional representation on a large scale in the German Empire." 
3. 
 *Denmark.* - Proportional representation has been applied to municipal elections, the measure passing both Houses of Parliament on April 14th,1908. 
4. 
 *Saxony.* - The Government has included proportional representation in its new electoral proposals. 
5. 
 *Holland.* - The Constitutional Commission appointed bv the Dutch Government has reported in favour of amending the fundamental law so as to render possible the adoption of proportional representation. 
...
{: type="A" start="I"}
0. have quoted reports in respect of the electoral systems of 'different countries which have adopted a more modern system than we have. I think I have proved to. the House that our system is so defective that it requires to be carefully considered, and that reform is absolutely necessary. The aims of the Proportional Representation Society are - 

    {: type="1" start="1"}
    0. To reproduce the opinions of the electors in Parliament and other public bodies in their true proportions. 
    1. To secure that the majority of electors shall rule and all considerable minorities shall be heard. 
    2. To give electors a wider freedom in the choice of representatives. 
    3. To give representatives greater independence from the financial and other pressure of small sections of constituents. 
    4. To ensure to parties representation by their ablest and most trusted members. 


The Proportional Representation Society explains its methods as follows - 

{: type="1" start="1"}
0. Unite existing constituencies into larger ones returning three or more members -each, having regard to natural divisions of the country - 
...
{: type="1" start="2"}
0. Decide elections by a proportionate system such as that known as the single transferable vote, under which - 

    {: type="a" start="a"}
    0. Each elector has one vote and one vote only. 
    1. The elector votes - 
    2. By placing the figure1 opposite the name of the candidate he likes best. 


He is also invited to place - 

{: type="a" start="b"}
0. The figure 2 opposite the name of his second choice. 
1. The figure 3 opposite the name of his third choice, and so on, numbering as many candidates as he pleases in the order of his preference, 

    {: type="a" start="c"}
    0. A candidate to ensure election need not . poll a majority, but only certain proportion of the votes cast. This proportion, which is the least number of votes sufficient to render certain the election of a candidate is called a quota. Thus, in a single member constituency a candidate who polls more than one-half of the voles must be elected ; the quota is therefore one more than; half. So in a two member constituency the quota is one more than a third, for not more than two candidates can poll so much, and in a three member constituencyone more than a fourth, and so on. Therefore, to ascertain the quota, divide the total of the votes by one more than the number of seats to be filled and add one to the result. 
    1. The returning officer ascertains the result ; of the election as follows :  - 

    {: type="1" start="1"}
    0. He counts each ballot-paper as one vote to the candidate marked 1 thereon ;  ' he also counts the total number of votes. 
    1. He ascertains the quota. 
    2. Hedeclares elected the candidates who have received the quota. 
    3. He transfers in strict proportions the surplus votes of those candidates who have received more than the quota, and credits them to the unelected candidates - 
...
{: type="1" start="5"}
0. He declares elected those candidates who after the transfer of surplus votes have obtained the quota. 
1. 'He eliminates the candidate lowest on the poll one after another by transferring their votes in accordance with the wishes of their supporters to the candidates indicated as next preferences. This process is continued until the required number of candidates having each obtained the quota have been declared elected, or the number of candidates not eliminated is reduced to the number of seats still vacant, in which event the candidates not eliminated are declared elected. 
