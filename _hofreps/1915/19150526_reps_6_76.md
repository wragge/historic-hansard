...
-- But the Minister must see that, standing by itself, the report he has read is entirely misleading. Beading it by itself, one wo\ild imagine that the figures referred to all the sickness in the camp, whereas I understand that the sick are removed daily to hospitals. 
...
{: type="1" start="1"}
0. That the statement made by Private R. B. Campbell in his letter to his mother is untrue. 
...
{: type="1" start="4"}
0. That one copy, or part, was sent to the Administrator by the O.C. Troops, and copy forwarded by the Administrator to the  Hon.  the Minister of Defence. 
...
{:#debate-28}
### MAJOR-GENEEAL SIR WILLIAM BRIDGES,K.C.B., O.M.G
