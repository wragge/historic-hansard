...
debates:
  ...
  - title: "QUESTION"
    ...
    type: questions
    subdebates:
      - title: "LETTER BY MR. BRUCE SMITH"
        id: "#subdebate-8-0"
  - title: "QUESTION"
    id: "#debate-9"
    type: questions
  ...
  - title: "QUESTION"
    ...
    type: questions
    subdebates:
      - title: "SUGAR DUTY AND THE LABOUR PLATFORM"
        id: "#subdebate-17-0"
  - title: "QUESTION"
    id: "#debate-18"
    type: questions
  ...
  - title: "QUESTION"
    ...
    type: questions
    subdebates:
      - title: "PAPUA : COPPER MINING"
        id: "#subdebate-21-0"
  - title: "QUESTION"
    id: "#debate-22"
    type: questions
    subdebates:
      - title: "PUBLIC SERVICE: LEAVE OF ABSENCE"
        id: "#subdebate-22-0"
  - title: "QUESTION"
    id: "#debate-23"
    type: questions
  ...
  - title: "QUESTION"
    ...
    type: questions
    subdebates:
      - title: "FOODSTUFFS: EXPORTS"
        id: "#subdebate-26-0"
  - title: "QUESTION"
    id: "#debate-27"
    type: questions
    subdebates:
      - title: "LIGHTHOUSES, WESTERN AUSTRALIA"
        id: "#subdebate-27-0"
  - title: "QUESTION"
    id: "#debate-28"
    type: questions
    subdebates:
      - title: "WHEAT CROP : SHIPPING FACILITIES"
        id: "#subdebate-28-0"
  - title: "QUESTION"
    id: "#debate-29"
    type: questions
...
* [QUESTION](#debate-2)
    * [CONTROL OF FOODSTUFFS](#subdebate-2-0)
* [PAPERS](#debate-3)
* [QUESTION](#debate-4)
    * [SMALL ARMS FACTORY](#subdebate-4-0)
* [QUESTION](#debate-5)
    * [WAR LOAN](#subdebate-5-0)
* [QUESTION](#debate-6)
    * [SUPPLY OF SUGAR](#subdebate-6-0)
* [QUESTION](#debate-7)
    * [COAL FOR GREAT BRITAIN](#subdebate-7-0)
* [QUESTION](#debate-8)
    * [LETTER BY MR. BRUCE SMITH](#subdebate-8-0)
* [QUESTION](#debate-9)
    * [PARLIAMENT HOUSE REFRESHMENT BAR](#subdebate-9-0)
* [QUESTION](#debate-10)
    * [EXPEDITIONARY FORCES](#subdebate-10-0)
* [QUESTION](#debate-11)
    * [SPEECH BY DR. RENTOUL](#subdebate-11-0)
* [QUESTION](#debate-12)
    * [ARRANGEMENT WITH BANKS](#subdebate-12-0)
* [QUESTION](#debate-13)
    * [RECRUITING CAMPAIGN](#subdebate-13-0)
* [QUESTION](#debate-14)
    * [MANUFACTURE OF MUNITIONS](#subdebate-14-0)
* [QUESTION](#debate-15)
    * [AUSTRALIAN PRISONERS IN TURKEY](#subdebate-15-0)
* [QUESTION](#debate-16)
    * [NORTHERN TERRITORY](#subdebate-16-0)
* [QUESTION](#debate-17)
    * [SUGAR DUTY AND THE LABOUR PLATFORM](#subdebate-17-0)
* [QUESTION](#debate-18)
    * [IMPERIAL WAR LOAN](#subdebate-18-0)
* [QUESTION](#debate-19)
    * [EXPEDITIONARY FORCES](#subdebate-19-0)
* [QUESTION](#debate-20)
    * [POSTMASTER-GENERAL'S DEPARTMENT](#subdebate-20-0)
* [QUESTION](#debate-21)
    * [PAPUA : COPPER MINING](#subdebate-21-0)
* [QUESTION](#debate-22)
    * [PUBLIC SERVICE: LEAVE OF ABSENCE](#subdebate-22-0)
* [QUESTION](#debate-23)
    * [KALGOORLIE-FREMANTLE RAILWAY](#subdebate-23-0)
* [QUESTION](#debate-24)
    * [SMALL ARMS FACTORY](#subdebate-24-0)
* [QUESTION](#debate-25)
    * [PUBLIC SERVICE : PREFERENCE TO UNIONISTS](#subdebate-25-0)
* [QUESTION](#debate-26)
    * [FOODSTUFFS: EXPORTS](#subdebate-26-0)
* [QUESTION](#debate-27)
    * [LIGHTHOUSES, WESTERN AUSTRALIA](#subdebate-27-0)
* [QUESTION](#debate-28)
    * [WHEAT CROP : SHIPPING FACILITIES](#subdebate-28-0)
* [QUESTION](#debate-29)
    * [INVALID AND .OLD-AGE PENSIONS](#subdebate-29-0)
* [QUESTION](#debate-30)
    * [REEF TRUST](#subdebate-30-0)
* [QUESTION](#debate-31)
    * [COCKBURN SOUND NAVAL BASE](#subdebate-31-0)
* [QUESTION](#debate-32)
    * [ESTIMATES, 1914-15](#subdebate-32-0)
...
{: type="1" start="1"}
0. Whether the complaint made by the council of the Queensland. Chamber of Manufactures about the quality of the boots being supplied to the troops lias been considered by the Department of Defence? 
1. If so, will he inform the House as to the result of such inquiry? 
...
{: type="1" start="1"}
0. Whether a recommendation has been made by the Examiner 6f Stores that, in order to overcome the serious defects in the supply of boots for the Expeditionary Forces by private contractors, " a Government tannery and boot factory should be established to work in conjunction with the Harness Factory"? 
1. If so, does the Minister regard the pro posal favorably? 
...
{: type="1" start="1"}
0. The Examiner of Stores in his report suggested the establishment of a Government tannery and boot factory as a means of overcoming the difficulties which the Department has experienced in the boot supply. 
1. The Minister is favorable to the proposal, but at the present juncture, owing to the pressure on the Department, and the fact that such a factory could not be established in time to be of service during the present war, it is not proposed to  take  any  action  at the present time. 
...
{: type="1" start="1"}
0. Has a recommendation been made to the 
...
{: type="1" start="2"}
0. Does the Minister propose to give effect to the recommendation, and, if so, when? 
...
{: type="1" start="1"}
0. No; but the Examiner of Stores has re ported that it has been necessary to reject a large number of boots supplied by  **Mr. Henry**  Harris, and that such action has resulted in. an improvement in the quality of the boots tendered for acceptance. 
1. See reply to 1. 
...
{: type="1" start="1"}
0. Whether it is a fact that the weekly half- holiday enjoyed by the country and outer suburban letter carriers for the past twentyfiveyears lias been abolished since his acceptance of office? 
1. Will he seek to amend the Public Service 
...
{: type="1" start="1"}
0. No. In any case where a weekly half- holiday can be allowed a letter carrier without interference with public business it is granted. It is not practicable in every case, as mail arrangements will not permit, but in none will a letter carrier be required to work more than forty-four hours per week. The weekly hours have been defined by the Arbitration Court, which disallowed the claim made by the letter carriers for a compulsory weekly half-holiday, recognising that the conditions under which departmental business must be carried on makes it impracticable in every case. 
1. The conditions of employment of letter carriers have been defined by the Arbitration Court, and an amendment 'of the Public Service Act is not required. 
...
{: type="1" start="1"}
0. Whether the Department is going to increase the allowance for forage for mounted  letter carriers? 
1. How many more reports will be called for before an increase can be recommended? 
2. Is it not a fact that private employers  have  long since raised this allowance to employees, also that the New South Wales Railways Commissioners have done the same thing? 
3. If the Department cannot afford to pay  the  increase, will he allow mounted letter carriers to turn out their horses till normal times return? 
...
{: type="1" start="1"}
0. Public Service Regulation 164 provides,  *inter alia,*  that where the maximum rate is considered to be inadequate to meet the actual expenses of any officer, the Commissioner, on reasonable cause being shown, may authorize sin increased rate. Full consideration will be given to applications from officers concerned +,o the Deputy Postmaster-General of the State in which they are employed for increased forage allowance, as provided by the regulation. 
1. No more than are necessary to enable the Applications to be properly dealt with. 
...
{: type="1" start="1"}
0. In view of the reply setting out the functions of letter carriers and assistants, as reported in  *Hansard*  of the 2nd of June, will he see that letter carriers and assistants are not required to do any additional duties without extra remuneration? 
1. Under the new system now operating in the letter carriers' room, Melbourne, is it proposed to fill the present letter sorters' staff in the letter carriers' room, when vacancies occur, by appointing letter carriers and assistants to do the work at letter carriers' and assistants' rates of pay? 
2. Will the Postmaster-General call for a return showing the extra staff necessitated by the introduction of the new system in the letter carriers' room, Melbourne, and also the approximate increased cost involved? 
3. Is it a fact that the new system in the letter carriers' room, Melbourne, is affecting the business community of Melbourne in consequence of late delivery of letters? 
...
{: type="1" start="1"}
0. The statements of functions cover the duties ordinarily required to be performed by the classes of officers mentioned; but, in accordance with a ruling of the Court, they may be called upon to perform any other duties without extra remuneration, so long as such duties are not higher in value than those prescribed by functions and the hours of duty fixed by the Arbitration Court are not exceeded. 
1. Yes. This' is necessary, in order to make the practice in Melbourne uniform with other States, the work being considered proper to a letter carrier or assistant in the Mail Branch. 
2. It is not considered necessary to obtain the return asked for. It has been" ascertained that, owing to a misunderstanding, the instructions have not been properly carried out, with the result that a temporary increase of staff was necessary. It is anticipated that when the new system is in proper working order, no extra staff or increased cost will be necessary. 
3. The Deputy Postmaster-General, Melbourne, reports that the new system as introduced was the cause of certain delays during the first week; but these delays are now much reduced, and matter should soon be delivered at usual times. See also  answer  to No. 3. 
...
{: type="1" start="1"}
0. Which section of the Public Service Act gives the Commissioner power to impose tests on officers transferred from the State to the Commonwealth Service? 
1. Which section of the Public Service Act gives the Commissioner the power to fix the functions of any officer of the Postal Department? 
2. Is it not the duty of the PostmasterGeneral to fix the functions of every officer, and the Commissioner to fix the rates of pay? 
3. Has the" Public Service Commissioner the power to change the designation of officers, immediately after an arbitration award, from " letter carrier " to " postman " when they are registered as letter carriers in the award? 
...
{: type="1" start="1"}
0. Under section 42 of the Public Service Act the Commissioner is required to assess the qualifications of officers seeking promotion. Section 80 gives power to make regulations for carrying out the provisions of the Act. Regulation 52 deals with promotion tests. 
1. The general powers conferred upon the Commissioner by section 8 of the Act are very wide. Under them he may propose to the Governor-General in Council such disposition of officers and offices, and re-arrangement or improved method of carrying out any work considered necessary or expedient for the more economic, efficient, or convenient working of the . Department. Where the Executive does not agree to any such proposal, reasons for such disagreement must be laid before Parliament. 
2. No. 
3. Only where such action docs not interfere with any benefits or privileges secured by the award. 
...
{: type="1" start="1"}
0. No, except by the honorable member. 
1. We parted with the understanding that I, as Treasurer, should do my best to help raise the money for Western Australia for that work. 
2. Yes, as soon as available. 
...
{: type="1" start="1"}
0. Whether it is the intention of the Government to proceed with the erection of light houses on the Western Australian coast, as recommended by Commander  Brewis? 
1. If so, will the Minister say exactly which lighthouses will be provided for on the Estimates for 1915-16? 
...
{: type="1" start="1"}
0. Yes. 
1. Lighthouses for which provision is made in the 1915-16 Estimates are: - 
...
{: type="1" start="1"}
0. Is he aware that old-age and invalid pensioners are suffering severely, owing to the increased cost of living? 
1. Will ho take an early opportunity of increasing the pension from 10s. to 12s. 6d., as promised? 
...
{: type="1" start="1"}
0. Yes, in common with others. 
1. This matter will bo considered with other financial matters which will claim attention when the Budget policy is determined. 
...
{: type="1" start="1"}
0. Whether he has yet made the inquiries with reference to the allegations as to the American Beef Trust promised in this House on 9th June, 1915? 
1. If he has, what was the result of the said inquiries? 
...
{: type="1" start="1"}
0. Yes. 
1. The Morris Beef Company, of Chicago, mentioned in the report of the Royal Commission on the Meat Export Trade as the purchaser of an area near Brisbane, has sent a representative to Queensland to arrange for the erection of a large meat works at an early date. 
...
{: type="1" start="1"}
0. Whether the tugboats required in connexion with the dredging at Henderson Naval Base have yet been secured? 
1. If so, will the Minister give full particulars of the vessels secured? 
2. On what date did the dredging operations commence ? 
...
{: type="1" start="1"}
0. One tug is at present on hire. It is intended to construct another tug for the Department. 
1. Steam tug  *Albatross,*  single screw, dimensions 72 feet long, 14 feet beam, 9 feet deep, 260 horse-power; speed, 10 knots. 
2. 24th June, 1915. 
...
{: type="1" start="1"}
0. Whether complete drawings have bees, prepared for the construction of the necessary breakwaters at the Henderson Naval Base? 
1. Has a commencement been made with  this  phase of the work, and what plant is at present being used? 
2. Have arrangements yet been made for the engines and trucks required for the construction of the breakwaters? 
...
{: type="1" start="1"}
0. Plans and drawings are in course of preparation. 
1. No. Specifications for plant required are being prepared, and will be advertised shortly. 
2. Negotiations are in progress for obtaining locomotives from the Western Australian Government. Tenders have been invited for the supply of wheels and axles for trucks. Timber bodies for trucks are in course of construction on the works. 
...
{: type="1" start="1"}
0. Is it a fact that the residence of the Engineer in Charge at Cockburn Sound has been furnished by, and at the expense of, the Commonwealth Government? 
1. Are there any other instances of furniture being supplied to Commonwealth officers' homes; and, if so, what is the rule in regard to this matter? 
...
{: type="1" start="1"}
0. Yes. 
1. Yes; it is customary for a charge to be made at the rate of 7£ per cent, per annum on the value of such furniture. " Financial Regulation 35  *(a)*  for the Naval Forces deals with  the  matter. 
...
{: type="1" start="2"}
0. An alteration was made in this locality some time ago which necessitated the removal of another 40-ft. pole, and the cost of the work, namely, £30 19s. 6d., was borne by your council. The fact that a second pole would also be standing in the roadway if the council proceeded with the alterations which it had in view, was represented at the time. In a communication dated 22nd October, 1913, however, your council intimated that it was the intention to remove the footpath out, so that the telephone pole would be on the alignment, and that there would, therefore, be no necessity to remove the pole. 
1. It would now appear that the council has not adhered to its original intention in this matter, and has carried out the alterations, with, as already stated, the result that the pole in question is left standing in the roadway. 
2. The total estimated cost of removing the pole is £48, of which, approximately, £26 representing the cost of the irrecoverable material, labour, cartage, fares, and supervision, will be chargeable- to your council. 
3. As the pole is in  *a*  dangerous position, instructions have been given for it to be removed with the least possible delay. 
...
{: type="1" start="1"}
0. There is an absence of business methods in the Department. 

That is a general statement. 

{: type="1" start="2"}
0. Errors occur in the sorting and delivery of letters which display carelessness and lack of discipline. 
...
{: type="1" start="3"}
0. There are instances of non-delivery and delay in delivery of telegrams. 

I can quite understand that. 

{: type="1" start="4"}
0. The Melbourne telephone service is most unsatisfactory. 
1. The Department employs untrained fitters at less than standard rates. 
2. Pole-dressing is executed by nontradesmen. 
...
{: type="1" start="1"}
0. More business-like management and decentralization are necessary. 

I believe that the Postmaster-General has endeavoured to decentralize some of the work. 

{: type="1" start="2"}
0. Postage rates and stamps are not uniform. Penny postage and a Commonwealth stamp should be introduced. 

We effected that change as soon as the nuances would permit. 

{: type="1" start="3"}
0. Delays occur in delivery of telegrams. 
1. Receipts for telegrams should be introduced. 
2. In telegrams a lower rate should be charged for words in excess of first sixteen. 
3. Department should not retain private telegrams of advice in connexion with telegraphic money orders. Department should advise payee. 
4. Telephone service, Port Adelaide, is most unsatisfactory. 
5. Telephone service between Adelaide and Port Adelaide is very bad. 
6. Gawler Post-office accommodation is inadequate. 
7. The office arrangements at Kapunda are defective. 
8. Post-offices at Mount Gambier and Kapunda are undermanned. 
9. Delays have occurred in furnishing private letter boxes at Kapunda. 
10. A telephone trunk line is required between Kapunda and Adelaide. 
11. Telephone trunk line charges are too high. 
12. Charges for extension of country telephone subscribers' lines are excessive. 
...
-- I have directed that that practice  be  abolished, .and the deposits returned or credited to the subscribers' .accounts with the .Department. [163]- 2 
...
{: type="1" start="1"}
0. Is he aware of the unsafe condition, and also the unsuitability, of the post-office in Oxfordstreet, Sydney? 
1. If so, will he take steps to insure the longpromised removal of the disability which thepublic suffer in this respect? 

The reply forthcoming was - 

{: type="1" start="1"}
0. I am aware that the present premises donot accord with the importance of the Oxfordstreet Post-office, and provision is being madefor the purchase of a site for a new office during the current financial year. 
...
<graphic href="077331191506306_61_0.jpg"></graphic>
