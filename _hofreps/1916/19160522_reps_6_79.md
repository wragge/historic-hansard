...
{: type="1" start="8"}
0. 
 *- (1). The rates of pensions payable under* 
 *this Act shall be as follows: -* 


    {: type="A" start="A"}
    0. 
 *In case of the death of a member of the Forces -* 


    {: type="a" start="i"}
    0. 
 *to the widow, the rate speci* 
 ...
 *In case of the total incapacity of a member of the Forces -* 
    ...
    {: type="a" start="i"}
    0. to  *the member, the rate specified in column three of the Schedule opposite to the rate of pay of the member, . and {ii) to the wife of the member, Fifty per centum of that rate, and* 
 ...
 *In case of the partial incapacity of a member of the Forces, such less rates than those referred to in paragraph (B) as are assessed by the Commissioner or the Deputy Commissioner, as the case may be, having regard to the nature and probable duration of the incapacity.* 
    ...
    {: type="1" start="2"}
    0. 
 *Notwithstanding anything contained in this section, the maximum rate of pension payable to a child both ofwhose parents are dead, or whose mother is dead and whose father is totally or partially incapacitated shall be Nineteen pounds ten shillings per annum.* 
...
##### Mr HIGGS:<br><small class="text-muted">Treasurer &middot; ALP</small>
...
{:#debate-26}
### COMMONWEALTH PUBLIC SERVICE (ACTING COMMISSIONER) BILL
...
<graphic href="079331191605223_48_1.jpg"></graphic>
