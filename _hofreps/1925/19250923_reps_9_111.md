...
##### Mr PRATTEN:<br><small class="text-muted">Minister for Trade andCustoms &middot; Martin &middot; NAT</small>
...
<graphic href="111331192509235_30_2.jpg"></graphic>
...
{: type="1" start="1"}
0. 1 ) A road suitable for motor traffic to be constructed from Alice Springs through Arltunga District to Lake Nash Station, on the Queensland border. 
1. To have a mail service from Alice Springs, through Arltunga District, to link up with the Queensland mail service. 
...
{: type="1" start="1"}
0. Postal articles posted and received (parcels post and registered articles not included) - 2,000 per annum or under. £3; over 2.000 and up to 3,000 per annum, £4; each1,000 or part over 3,000 per annum, 5s. 
1. Registered articles registered locally or received in mails, one penny each. 
2. Parcels post (same as registered). 
3. Value payable parcels posted and received, threepence each. 
4. Mails received and dispatched (including free bags, but not including private mail bags), per annum - 312 or under, £4; over 312 up to 624, £6; each 312 or part over 624, £2. 
5. Private mail bags - For each service: not more than thrice weekly, £1 ; more than thrice weekly, but not exceeding six times a week, £2; more than six times a week, £4. 
6. Night attendance for receipt and dispatch of mails - For each weekly attendance: between the hours of 6 p.m. and 10 p.m. and 6 a.m. to 9 a.m., £1 per annum; 10 p.m. to 6 a.m., £2 per annum. 
...
{: type="1" start="8"}
0. Sunday attendance for mail work only - Where regular Sunday work is necessary, for each attendance, £2 per annum. 
1. Postal notes sold - Twopence per complete £1 worth sold. 
2. Postal notes paid (money order offices only) - Twopence per complete £1 worth paid. 
3. Money orders - Threepence for each order issued; 2d. for each order paid. 
4. Savings Bank - Five shillings per cent. on amount of deposits and withdrawals. 

That is a very niggardly rate. It is well known that the average Savings Bank operation is not a very large one. 

{: type="1" start="13"}
0. Telegrams (including service messages) -Twopence for each telegram dispatched; 3d. for each telegram received and enveloped. 
1. Telegrams in transit - Twopence for each cross telegram transmitted. 
2. Telephones - 

    {: type="a" start="a"}
    0. Attendance to trunk line and network calls where coin attachments are not provided, 40 per cent. of the total revenue derived at the office from these sources. 
    1. Where coin attachments are provided for network calls, 40 per cent. of the trunk line revenue collected, and at the rate of id. per call of the network revenue collected. 
    2. Attendance to main or branch telephone trunk lines, one penny per switch. 
    3. Telephone exchange duties - (1) allowance for attendance, 10s. per annum for each subscriber to an exclusive service. 
