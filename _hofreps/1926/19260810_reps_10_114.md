...
{: type="1" start="1"}
0. As a strategic necessity. 
1. In continuation of the* policy of preparing routes to enable aircraft to fly to anywhere in Australia in safety. 
2. To supply rapid communication in a district that is urgently in need of same. 
 ...
 *Flying Accidents.* 
    ...
    {: type="a" start="a"}
    0. The principal causes of flying accidents in the Royal Australian Air Force have been due to errors of judgment on the part of the '  flying personnel concerned, resulting in a stall at low altitudes and an incipient spin, the aeroplane striking the earth whilst in an uncontrolled state. 
    1. There is nothing in the evidence of any of the courts of inquiry on fatal accidents which would convey the slightest suggestion that any have been due to faulty material or to the fault of personnel, other than the occupants of the aeroplane involved. 
    2. The development of aeronautical design as applied to service aeroplanes has not yet reached the stage where stalling can be eliminated. The stall is a fundamental inherent phenomenon in the conventional type of aeroplane, and the total prevention of flying accidents due to stalling cannot yet be foreseen. 
    3. Certain developments are taking place, which aim at increasing the control in stalled aeroplanes, or giving warning of an approach to stalling speed, and so tend to reduce accidents following a stall. 
...
{: type="a" start="e"}
0. The Air "Board is kept informed of the progress of such developments by its liaison officer at the Air Ministry. 
...
1. The types of aeroplanes in use in the 
...
{: type="a" start="b"}
0. Although new and modern types of aeroplanes are essential if the Royal Australian Air Force is to be efficiently equipped for war, the present necessity for making use of the types available for training purposes does not impose any avoidable risk on personnel. New aeroplanes would not eliminate flying accidents. 
1. The aeroplanes received from the Imperial Government and reconditioned here are thoroughly airworthy before being put into service, and that the steps taken to ensure this are adequate and satisfactory. 

The following are. the chief "reasons for the reconditioning of these aeroplanes before being taken into use: - 

{: type="i" start="i"}
0. To incorporate essential modifications that were issued after the machine had been built, and had therefore been omitted. 
1. To eliminate certain "concessions" which had been granted to assist production during the war, but which are considered inadmissible in a time of peace, either because they decrease the factor of safety or the" performance of the machine, or are for other reasons undesirable. 
2. To introduce improvements which had been perfected since the machine was first built; as, for example, the substitution of all-metal petrol pipelines in place of petrol-resisting rubber connexions. 
3. To make good damage done while the machine has been stored, or de terioration which has taken place in the more perishable parts of the machine during storage. 

    {: type="a" start="v"}
    0. To eliminate any inspectional errors which may have occurred under war conditions. 
    1. The steps taken to ensure airworthiness of aircraft whilst in the service are adequate and no additional measures for their improvement can be suggested. 
    2. The evidence of flying instructors,flying personnel generally, pupils and mechanics, shows that there is no disinclination onthe part of any member of the Royal Australian Air Force to fly any aeroplane now in the service. Such evidence indicates that the exact opposite is the case. 

    {: type="1" start="3"}
    0. Personnel. 

    3. The evidence indicates that the medical requirements insisted upon in instructors and pupils under instruction in flying are of the highest standard, and adequate. 
    4. The instruction imparted to pupils undergoing training as pilots is sound, thorough, and adequate, and cannot at the moment be improved upon. 
    5. The instructors are properly qualified for the work, and compare favorably with those in any other part of the British Empire. 
 ...
 *Statistics.* 
    ...
    6. The amount of instruction given to, and the amount of air experience gained, by pupils during their course is greater than in other British air forces, for which figures are available. 
    7. The numbers of fatal accidents in the Royal Australian Air Force, as compared with other parts of the British Empire, are not abnormal. 
    8. In spite of the unfairness of comparing the numbers of accidents to persons under training in the Royal Australian Air Force with those of trained pilots engaged in civil aviation, the former have not been greater than the latter since the Royal Australian Air Force was formed in March, 1921. 
...
{:#subdebate-15-4}
#### Re Ex No. 2826 Trooper F. H. Needham, 14th L.H. Regiment
