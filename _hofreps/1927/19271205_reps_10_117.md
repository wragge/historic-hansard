...
<graphic href="117331192712053_35_0.jpg"></graphic>
...
{: type="a" start="b"}
0. it is desirable that counsel's opinion be taken as to the wisdom and practicability' of making alterations in the Customs Act to enable the same incidence of duties on all cargo discharged at all Australian ports  *ex*  the same vessel. 
