...
{: type="a" start="a"}
0. That £12,000 be refunded to the representatives of male officers who have died or who die in the Service and who were or are either single men or widowers without children under the age of 16years; 
1. That an amount of £2,000 be utilized in increasing children's pensions from £13 to £20 per annum in the case of children who have lost both parents; and 
2. That £29,000 be distributed as a cash benefit on the basis of £5 a unit on the death of a contributor or a pensioner who has been a contributor. 
...
{: type="1" start="1"}
0. .  One body forming machine for making the can bodies. 
1. One automatic feed stamping press for making tops and bottoms for same (guaranted to stamp 160 lids per minute). 
2. One rotaryflanging machine for cans. 
3. One superseamer closing machine guaranteed to close 200 cans per minute. 
4. One combination die for the stamping press. 
5. One exhaust box for one of our canning lines. 
...
{: type="1" start="1"}
0. Body-forming machine has never made satisfactory cans nowithstanding the fact that the Australian manufacturers had from time to time from one to three of their own men from Sydney to try and put it right over a total period of about four to six weeks, and we then had to abandon all attempts to make cans on the machine for last season. The soldering and the side seam work were both unsatisfactory, and in addition, two main driving gear wheels wore out twice within two weeks though only working part time. 
1. Automatic feed stamping press was very unsatisfactory for several weeks as the crank bearings could not be stopped from running hot and seizing. The feed can had to be altered and the Australian manufacturer's man had to give the machine a lot of attention for weeks to make it work at all. When the first difficulties were overcome it was found that the machine produces 25 fewer lids per minute than a similar American machine which is now six years old. 
2. Rotary flanging machine. The chucks for this machine were unsatisfactory and had to be replaced by us. Otherwise this machine has operated satisfactorily. 
3. Closing machine. The Australian manufacturers had from one to three men (including their chief draftsman who designed the machine, and also two members of thefirm) working on this machine for about ten weeks without succeeding in making it close cans satisfactorily. While trying to remedy the faults the castiron main driving sleeve broke down on two occasions. This was then replaced by a steel sleeve without making the machine do proper work. During this period we gave the manufacturer's men every assistance, but eventually had to refuse to accept the machine and are holding it on their account at our factory. 
...
{: type="1" start="5"}
0. Combination die. This cost us £32, but was unsatisfactory and had to be scrapped soon after the machine was installed, and we have had to alter machine in order touse American dies. 
1. Exhaust box. In this case the machine worked satisfactorily for one season, but when overhauled was found to be so badly worn in certain parts that we had to go to the expense of replacing a considerable number, whereas similar type American machines working alongside the Australian machine have done six seasons and still do not require any of the replacements referred to. 
