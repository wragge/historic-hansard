...
{: type="i" start="1"}
0. . being primary products which are derived directly from operations carried on in Australia in - 

    {: type="i" start="i"}
    0. mining; 
    1. the cultivation of land; 
    2. the maintenance of animals, poultry, and bees; 
    3. fisheries; or 
...
{: type="a" start="a"}
0. makes any of the sales specified in section eighteen of this act; or 
1. applies to his own use any goods specified in sub-section (2.) of section eighteen of this act, shall, within seven days after the close of that month, furnish to the Commissioner a return in the prescribed form - 
2. in cases to which paragraph (a) of this sub-section applies - setting forth the aggregate of the amounts for which the goods were sold during that month, together with the aggregate of all discounts, rebates, deductions or other credits given during that month in respect of those sales, and such other information as is prescribed; 
...
{: type="1" start="1"}
0. Because the amendments contain provisions which are contrary to the principles of the bill. 
1. Because the amendments do not effectuate the policy for which the Government received a mandate at the last elections. 
...
<graphic href="126331193008064_68_0.jpg"></graphic>


The value of the same goods, in the case of a retailer, would be as follows: - 


<graphic href="126331193008064_68_1.jpg"></graphic>
...
{: type="1" start="1"}
0. For the purposes of this act, the sale value of goods imported into Australia on or before the first day of August, One thousand nine hundred and thirty - 

    {: type="a" start="a"}
    0. by an unregistered person; or 
    1. by a registered person who does not quote his certificate on the customs entry relating to the goods, shall be an amount which exceeds by twenty per centum the sum of the following: - 

    {: type="i" start="i"}
    0. the duty-paid value of those goods; and 
