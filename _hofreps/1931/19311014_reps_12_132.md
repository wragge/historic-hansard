...
{: type="1" start="1"}
0. Goods exempt from primage duty - (a)..... 

    {: type="a" start="b"}
    0. agricultural and horticultural seeds hot covered by any item in the Customs Tariff 1921-1930. 
...
0. Goods subject to primage  duty  at the rate of 4 per centum ad valorem - 
    ...
    {: type="a" start="b"}
    0. books and periodicals imported for public libraries. 
