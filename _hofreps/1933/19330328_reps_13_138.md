...
{: type="1" start="1"}
0. Although the principal manufacturer is producing 33 different lines, the range is not sufficient to meet trade requirements. 
1. The manufacture of other lines where the demand is small would result in higher costs to the Australian Manufacturer, with consequent increased costs to purchasers. 
2. The duty of 6d. .per square yard recommended under the British preferential tariff is equivalent to only slightly less than total wages paid' in Australia. 
3. After deducting the cost of raw materials from the selling prices, the charges for manufacturing, selling and profit iri Australia are equal to three times the charges for similar items in the United Kingdom. 
...
{: type="a" start="b"}
0. Clothes wringers for household use, ad valorem - British, 40 per cent.; general,60 per cent. 
...
{:#subdebate-17-0}
#### Matson Shipping Line- Trawling Industry: Survey of Fresh Grounds
