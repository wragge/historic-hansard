...
{: type="1" start="2"}
0. Complete Australian self-government as a member of the British Commonwealth of Nations . . . 
1. Amendment of the Commonwealth Constitution - 

    {: type="a" start="a"}
    0. To invest the Commonwealth Parliament with unlimited legislative powers and authority to create (or re-order) States or provinces with delegated powers. 

2. Abolition of State Legislative Councils and State Governors. 
