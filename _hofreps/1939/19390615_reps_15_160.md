...
* [SUPPLY BILL (No. 1) 1939-40](#debate-26)
...
<graphic href="160331193906155_46_1_3_P.jpg"></graphic>



<graphic href="160331193906155_46_1_2_N.jpg"></graphic>
...
{: type="a" start="a"}
0. The Junior Technical School system is not as adequate as it should bc. The facilities should be increased in the metropolis and extended in the large country towns. There is a somewhat surprising lack of record of the vocations followed by students from the school. I consider that greater efforts should be made to obtain increased attendance of students of suitable type at these classes, and that better records should be kept. That agricultural instruction of a  pre-vocational  1 nature be provided in the curricula of both city and country junior technical schools. 
...
{: type="1" start="1"}
0. The minimum age for leaving school and being admitted to employment should be fixed at not less than fifteen years as soon as circumstances allow. 
1. Maintenance allowances should, if necessary, be granted to parents by the competent public authorities during additional periods of education. 3.Juveniles who are no longer in full-time attendance at school should, until they reach the age of 18, be required to attend continuation courses providing both general and vocational education. 
2. Vocational training centres, in which some provision is made for general education, should be organized for' unemployed persons between the ages of 18 and 25, in co-operation with employers' and workers' organizations. 
3. Where it is considered desirable to establish, for unemployed persons between the ages of 18 and 24 inclusive, employment centres the principal object of which is not to give vocational training, but to provide work under conditions of employment other than those obtaining normally, adequate safeguards should be adopted to prevent these abnormal conditions from resulting in abuses. Attendances at employment centres should be strictly voluntary. Every care should he taken to prevent such centres, whether public or private, from becoming institutions for military training. Those privately organized should be under the supervision of the civil authorities. 
4. Measures should be taken to transfer to expanding occupations and to districts in which suchoccupations are carried on, young persons who are without employment in districts where the principal industries appear to be in permanent decline. 
5. Present attempts to promote re-employ- ment by a reduction in ordinary hours of work should be pursued with special vigour in respect of employment in which young persons engage. 
...
{: type="1" start="1"}
0. By direct legislation or through the medium of the arbitration courts, working in co-ordination with all the States - because without co-ordination the scheme would fail - to fix the proportion of juvenile labour in any given industry; 
1. By the enactment of laws operating under a co-ordinated plan which would prevent the employment of juveniles below a certain age; and in conjunction with that; 
2. By the adoption of uniform laws governing school leaving age. 
...
{: type="a" start="a"}
0. The existing organization of district bases, cavalry divisions and infantry divisions, all operationally independent, could not function, in the event of war, when the troops mobilized in the south-eastern area of Australia, i.e., in the States of New South Wales, Victoria, South Australia and Tasmania, must, for operational reasons, be grouped initially into two commands. 
1. It makes no provision for the personnel and whole-time guidance and supervision by a higher commander of divisional and other formation commanders on questions of training and general preparedness for war, which is necessary to secure uniformity of doctrine and method, and to ensure the maintenance by all units of a level and high standard in training and administration. 
2. At present, Army Head-quarters has to deal direct with the head-quarters of two cavalry divisions, four divisions, six district bases - four of which also function as the headquarters of mixed brigades - one independent command at Darwin, and, in addition, four permanent and, at times, three nonpermanent educational establishments. This inevitably leadsto congestion of work at Army Head-quarters, and to delay in dealing with the formations' requirements. 
...
{: type="i" start="i"}
0. Northern ' Command (Queensland) ; 
1. Eastern Command (New South Wales) ; . in) Southern Command (Victoria, South Australia, Tasmania - the two latter being selfcontained areas under the District Command) ; 
2. Western Command (Western Australia) ; and 
3. One independent garrison (Darwin). 
...
{: type="1" start="2"}
0. The Attorney-General "may, by order under his hand; direct that any person, not born in Australia, who is convicted of any offence under section thirty e thirty j or thirty q of this act, shall be deported from the Commonwealth. 
...
##### Mr PERKINS:<br><small class="text-muted">EdenMonaroAssistantMinister &middot; UAP</small>
...
{: type="1" start="1"}
0. Subject to this section, every alien in the Commonwealth shall, within the prescribed time and in the prescribed manner, make application to the Registrar for the subdivision in which the alien resides to be registered as an alien under this act. 
1. Nothing in the last preceding section shall apply to - 

    {: type="a" start="d"}
    0. an alien who does not intend to reside' in the Commonwealth, and does not remain in the Commonwealth, for more than sixty consecutive days; or 
