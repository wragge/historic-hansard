...
{: type="i" start="iv"}
0. Companies, but so that any such law shall be uniform throughout the Common wealth. 
...
{: type="1" start="1"}
0. A combination of interests for the purpose of regulating and controlling by means of a common authority the use) supply, and disposal of some kind of property ... a commercial or proxy trust. 
1. An organization or association of industrial corporations, a majority (at least) of the stock of each of which is transferred to a central committee or board of trustees who . . . exercise the voting powers of the stock in electing boards of directors for the various associated corporations and in other ways thus direct their policy for the common object of lessening competition, production, lowering its cost and increasing profit - a corporate trust. 
