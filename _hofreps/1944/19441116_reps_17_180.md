...
{: type="1" start="1"}
0. (The organization shall', in accordance with the procedure provided for in tho following paragraph, constitute a .part of any general international organization to which may be entrusted the co-ordination of the activities of international -organizations with specialized responsibilities. 
...
{: type="1" start="1"}
0. Amendments to this constitution involving new obligations for member nations shall require tho approval of the conference by a vote concurred in by a two-thirds majority of all the members of the conference and shall take effect on acceptance .by  two-thirds  of the member nations for each member nation accepting ibo amendment and thereafter for each remaining member nation on acceptance by it. 
...
{: type="1" start="2"}
0. The Organizationshall promote and, where appropriate, shall recommend national and international action with respect to - 
...
1. Itshall alsobe the function of the Organization - 

    {: type="a" start="a"}
    0. to furnish such technical assistances as governments may request; 
...
{: type="A" start="X"}
0. the allotted quantity or percentage share for export of each participating country. 
1. the arrangements for stabilizing prices (some will be fixed basic prices, others detailed  catalogued  prices, others stabilized within certain limits. " There may bc special prices for certain markets, &amp;c. ). 
2. the .maximum and minimum trading stocks or buffer stocks to bp carried by each country. 1 cannot, at tile moment, discuss all the details of this scheme, but I emphasize that it is not a wild cat proposal. It has  been  " vetted " by leading authorities in Great Britain and has been given considerable support in the House of  Commons  I have no doubt that the authorities will .be able to deal effectively with the whole project on the organizational side, for this has been widely discussed. 
