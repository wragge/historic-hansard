...
{: type="A" start="H"}
0. C. Brown (Auditor-General). 
1. j. Ryan (Dentist). 
2. H. Calthorpe (Estate Agent). 
3. W. Parsons (Manager, Commonwealth 

{:#subdebate-18-2}
#### Bank)

{: type="A" start="K"}
0. C. Waugh (Assistant Crown Solicitor). 
1. V. Lancaster (Sub-accountant, Treasury). 
2. T. Pinner (Inspector, Public Service 
...
{: type="A" start="A"}
0. R. Townsend (Inspector, Customs - Sugar 

{:#subdebate-18-4}
#### Expert)

{: type="A" start="W"}
0. Campbell (Parliamentary Reporter). 
1. L. Sheaffe (Survey, Department 
...
{: type="A" start="A"}
0. H. Boons (Clerk, Department Interior). 
1. Bushby (Clerk, Electoral Office). 
