...
<graphic href="186331194603271_36_3.jpg"></graphic>
...
{: type="a" start="c"}
0. A local government area with a population of less' than 5,000 and an area of less than 100 square miles is to be combined with the local authority area having an area of more than 100 square miles with which it has the longest common boundary. This provision is designed tomeet the same difficulty as in (b) but where the township is not completely surrounded by a rural area. In such cases it is to be combined with the rural area with which it has the longest common boundary. 
