...
{: type="a" start="a"}
0. discharged "Run"; 
1. dismissed from His Majesty's Service with disgrace; 
2. dismissed from His Majesty's Service; 
3. discharged from the service as " Services no longer required " or whose services are dispensed with on account of misconduct; or 
4. discharged at own request whether by voluntary retirement or resignation - shall be entitled to any payment under this regulation. 
