...
{: type="a" start="a"}
0. Banking, credit  and  insurance(including  sick,  accident,  life and unem  ployment) . 

Further on progressive reforms are set out in the report. We are certainly getting them now. These include - 

{: type="1" start="1"}
0. The  Commonwealth  Bank to be  developed  on  the following lines: - 

    {: type="a" start="a"}
    0. A nation wide  trading  bank  handling the  ordinary business of the  community. 
