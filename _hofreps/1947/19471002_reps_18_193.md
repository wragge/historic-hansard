...
{: type="a" start="a"}
0. In United States of America and Canadian cities - Hotel accounts for normal accommodation and sustenance only (excluding all charges for such items as refreshments, gratuities, tobacco, papers, laundry, &amp; c.) plus an allowance of $7.50 per day. 
1. In United Kingdom cities - Hotel accounts as above, plus an allowance of £E.l 10s. per day. 
2. When travelling between places - £.E.2 2s. per day (or $10 in United States of America and Canada) reduced to E.l0s. per day (or $2.50 in United States of America and Canada), when transport provided included sustenance. 
