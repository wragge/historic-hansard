...
{: type="1" start="1"}
0. Effective prices control was necessary. 
1. Control should be as uniform as possible. 
2. Closest collaboration on detailed implementation of controls was advisable. 
3. The impact of controls should be reduced as far as possible. Action should be taken immediately to survey the existing regulations; those not fundamental to economic stability should be eliminated. 
4. An advisory co-ordinating authority, comprising State Ministers concerned, should be set up to recommend the controls which should be dropped immediately and to advise on policy from time to time. 
...
{: type="a" start="a"}
0. The replacement of importsby Australian production. 
1. The replacement of imports by diversion of the source of supply. (ti) Increased exports to other sterling area countries in replacement of dollar imports by those countries. (ci Increased exports to other areas, e.g., South-East Asia, in replacement of goods now being imported from dollar areas, thus assisting potential dollar surplus countries. 
2. Further processing of goods now exported to dollar areas as raw materials, e.g., wool, metals. 
...
{:#debate-38}
### COMMONWEALTH AIDROADS AND WORKS BILL 1948
