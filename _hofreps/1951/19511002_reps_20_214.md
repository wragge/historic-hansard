...
##### Mr BLAND:<br><small class="text-muted">WARRINGAH, NEW SOUTH WALES &middot; LP</small>
...
{: type="1" start="2"}
0. A levy on the gross income from highpriced exports; 
1. A general increase in company tax, on a percentage basis and applicable to all companies; 
2. A rise in the rate of interest and restriction of time payment and hire purchase systems ;  *[5)*  The progressive development of a free exchange combined with the elimination of controls on exchange transactions and imports from hard currency areas; 
3. Budgeting for a surplus by means of the measures suggested above, together with higher sales tax and excise on luxury goods; 
4. A national drive to raise the level of productivity, especial.y in basic industries, together with additional efforts to obtain imports of essential materials and capital equipment. In view of the low level of production a resumption of a universal 44-hour week would give immediate relief; 
5. Depending on the trend of overseas prices, resumption of price control in an effective form, with subsidies on high-priced imports and exportable goods as developed during the war. 
