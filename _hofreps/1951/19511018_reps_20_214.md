...
{: type="1" start="3"}
0. That the Minister for External Affairs shall make available to the committee information within such categories or on such conditions as he may consider desirable. 
...
{: type="1" start="1"}
0. 1 ) That a Joint Committee be appointed to consider such matters concerning foreignaffairs as are referred to it by the Minister for External Affairs. 
...
{: type="1" start="2"}
0. That, twelve Members of the House of Representatives be appointed to serve on such committee. 
...
{: type="1" start="4"}
0. That, notwithstanding anything contained in the Standing Orders - 

    {: type="a" start="c"}
    0. the committee and its sub-committees will sit  *in camera,*  and their proceedings shall be  secret. 
...
{: type="a" start="e"}
0. The committee shall, for considerations of National Security in all cases forward its reports to the Minister for External Affairs, hut on every occasion when the committee forwards a report to the Minister, it shall in form the Parliament that it has so reported. 
...
{: type="a" start="f"}
0. the committee shall have no power to send for persons, papers or records without the concurrence of the Minister for External Affairs and all evidence submitted to the committee shall be regarded as confidential to the committee; 
...
{: type="a" start="f"}
0. the committee shall have power to send for persons, papers or records. 
...
{: type="A" start="A"}
0. M. Bickford and Sons Limited, Adelaide and Brisbane. 

Elliotts and Australian Drug Proprietary Limited, Sydney and Newcastle. 

{: type="A" start="L"}
0. Fairthorne and Son Proprietary Limited, Launceston and Hobart. 
