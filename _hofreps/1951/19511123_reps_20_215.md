...
{: type="a" start="1"}
0. i ) that the shell of such eggs are clean, uncracked, and are free from stain-- 
...
{: type="i" start="ii"}
0. that such eggs when candled are free from blood spots, and the yolks are translucent or but faintly visible and the whites are translucent and firm- 
...
{: type="i" start="1"}
0. . our fathers brought forth upon this continent a new nation, conceived in liberty and dedicated to the proposition that all men are created equal. 
