...
{: type="1" start="1"}
0. For substantially increased rates of hospital benefit having regard to the rise of hospital costs. 
...
{: type="1" start="2"}
0. For the negotiation of fresh agreements between the Commonwealth and the States to ensure that throughout Australia there should be no charge and no means test for qualified persons occupying beds in public wards of public hospitals. 
...
{: type="1" start="3"}
0. That payment of Commonwealth hospital benefits or medical benefits shall not be conditional upon a patient being a contributor to a hospitals fund or a medical benefits fund. 
...
{: type="1" start="7"}
0. That the provision of medical and hospital benefits should be financed from revenue raised on a graduated scale based upon capacity to pay. 
...
##### Mr E JAMES:<br><small class="text-muted">HUNTER, NEW SOUTH WALES</small>
...
{: type="I" start="II"}
0. , the radio facilities operated by the service were used to relay weather information to defence head-quarters. From the point of view of defence, the service has proved its value to the nation. 
