...
<graphic href="002131195312024_48_3_2_N.jpg"></graphic>



<graphic href="002131195312024_48_3_1_A.jpg"></graphic>
...
##### Dr EVATT:<br><small class="text-muted">Leader of the supports this bill. The passing of a statute which defines and describes the Australian national flag is an important event in the history of the nation.I think that it is important in many respects. The flag that is now Australia's national flag, which is based on the Blue Ensign, is a very beautifulflag. It is probably the most beautiful flag in the world. It incorporates the Union Jack, which indicates the integral association of Australia with the United Kingdom and the British Commonwealth of Nations. I do not think that there can be any objection to the other provisions of the bill. Although action to implement my suggestion cannot be taken now. I suggest that on some future occasion steps should be taken in order to prescribe rules, similar to those that are prescribed by the statutes of the United States of America, for the flying of the Australian national flag. The American statutes provide, for instance, the manner in which the flag shall be displayed and the days on which it must be displayed. They provide that when the flag is used on a speaker's platform it shall be displayed above and behind the speaker. They also provide that the flag should form a distinctive feature of the ceremony of unveiling a statue or monument but that it should never he used as a covering for a statue or monument. All of those provisions, of which I have mentioned only one or two, are designed to give to the flag of the United States of America a special significance. One of the most impressive features of the immigration scheme which was introduced when the honorable member for Melbourne (Mr. Calwell &middot; Barton</small>
...
{: type="a" start="a"}
0. a policy that has at any time been such a policy; and 
1. a paid-up policy (not being a policy expressed to be an ordinary policy) granted in lieu of such a policy or of a policy referred to in the last preceding paragraph ; 
...
{: type="a" start="a"}
0. he is employed in the Public Service of the Territory or of the Commonwealth ; 
