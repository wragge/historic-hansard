...
{: type="A" start="A"}
0. survey of the deposits of bauxite at Wessel Island has been made, and the cost of that survey has been borne by the commission. No reference to the cost has been made, but it has resulted in the addition of 10,000,000 tons of high-grade bauxite to Australia's resources. There must also be provision for working capital when the plant comes into commercial operation. The Minister referred to the vital importance of electric power and then made the following statement : - 
