...
{: type="A" start="I"}
0. . should be the first to . acknowledge that assimilation is a long process. Doubtless, it will not be . accomplished entirely until the next generation. I appreciate that children form the best link between immigrants , and Australians, but I am concerned about the non-British adults in  out  community. I stress the point, with all the vigour at my command, that one of the first steps in assimilation is for . non-British immigrants to seek naturalization status, if they are eligible to do so. The Government : should strain every nerve to encourage those who are qualified to take thatstep to do -so..Re- cently, whenI asked the Minister for Supplyfor figuresconcerning immigration, he told me that in1952the number of persons naturalized -was 1,681,that in 1953 it was 2,532, and that for the . first seven months of this year it was approximately 6,000. 
