...
{: type="a" start="b"}
0. the application of the person for registration was lodged with the Board by an employer registered at the port and there is endorsed on the application a recommendation by tha employer that the application be accepted. 
