...
* [QUESTION](#debate-13)
    * [SHIPPING OF POTATOES](#subdebate-13-0)
* [QUESTION](#debate-14)
...
##### Dr EVATT:<br><small class="text-muted">Leader of taa Opposition &middot; Barton</small>
...
{: type="a" start="a"}
0. to regulate, and control the performance of stevedoring operations, insofar as operations ure performed in the course of trade and commerce with other countries or among the States . . . 

    {: type="1" start="6"}
    0. to develop, or (subject to the approval of thu Treasurer) to make advances to port authorities for the development of, port facilities used in connexion with stevedoring operations, including thu introduction, modification, replacement and operation of machinery, plant and equipment. 
...
{: type="a" start="b"}
0. that the circumstances are not such as towarrant an increase in the quota for the port or the registration of waterside workers at the port . . . the Authority may declare . . . that, until the declaration ceases tobe in force, the employment of unregistered waterside workers ... is, in the public interest, permitted in accordance with this section. 
...
{: type="a" start="i"}
0. stevedoring operations for which he has engaged waterside workers are expeditiously, safely and efficiently performed. 
...
{: type="i" start="1"}
0. i ) to offer for or accept employment as a waterside worker; 
1. to commence, continue or complete an engagement for employment as a waterside worker; or, 
2. to perform any stevedoring operations which he was lawfully required to perform ;  his registration may be cancelled. Whether he is acting in conjunction with his fellow unionists, or in isolation, this tremendous power over him is given to the authority. Those are events which in the nature of things are not unlikely; they must occur from time to time in certain circumstances. The employer is placed in a very different position. After a waterside worker's registration is cancelled or suspended, he may lodge an appeal, which is heard by the court. 
...
{: type="a" start="a"}
0. a person from . . . offering for, obtaining or accepting employment.: 
...
{: type="a" start="a"}
0. to furnish to the Authority such information as the Authority requires, in such form as the Authority requires; and 
1. to attend to give evidence before the Authority, or before such other person as the Authority directs, with respect to any matter to which this Act applies and may require that person to produce all books, documents, papers and things whatever in his custody or control relating to any such matter. (2.) The Authority may require the information or evidence to be given on oath or affirmation and either orally or in writing, and for that purpose the  Chairman  of the Authority, or a person authorized by him in that behalf, may administer an oath. 

Then comes the penal provision - (3.) A person shall not - 

{: type="a" start="a"}
0. refuse or fail to comply with any requirement made in pursuance of this section; or 

Apparently the penalty for that is £50 - or 

{: type="a" start="b"}
0. with intent to evade the provisions of this section, destroy . . . any document. . . . 
...
{: type="1" start="5"}
0. The W.W.F. will so arrange things that, as far as practicable, consideration by Branch membership of quota increases and the admission of new members will be dealt with by means which do not involve interruptions to stevedoring operations. 
...
{: type="a" start="b"}
0. the Commission constituted by not less than three members (at least one of whom is a presidential member of the Commission) . . . 
