...
{: type="i" start="1"}
0. . that the basic grant would be paid only on the condition that the university received from its State a grant sufficiently large, when joined with income from fees, to balance the university's budget and to be three times as large as the basic grant. 
