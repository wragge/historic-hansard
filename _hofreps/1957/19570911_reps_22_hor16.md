...
{: type="1" start="1"}
0. should also like to take this opportunity of complimenting the Treasurer on the quality of the contents of the economic White Papers that have been produced by the Treasury from time to time. As records of trends and developments, they have been of tremendous value to honorable members, although they may have made the problem of the presentation of a budget speech more difficult, because they have given a preview of Treasury thinking on national problems. However, those papers have provided a background of solid factual information of an objective nature, and even if honorable members on either side of the chamber disagree with certain conclusions, we have been given a picture of the direction of Treasury thinking. 
...
{:#subdebate-24-0}
#### Hungarian Immigrants - Postal Department - Japanese War Criminals - Tariff Board
