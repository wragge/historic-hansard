...
{: type="a" start="r"}
0. -- -MO  into the. hands of men who are in no way responsible, to the sovereign people who vested the power in the Parliament. 
...
{: type="i" start="1"}
0. . the first step in the exercise of the Commissioner's discretion under Section 61 is to calculate the depreciation that would be allowable if the unit was used wholly for business purposes. In the view of the Court, only in this way can the " depreciated value " of the asset be correctly determined. 
...
{: type="1" start="1"}
0. That jurisdiction which is exclusive to the Commonwealth; 
1. That which is exclusive to the State; and 
2. That set of fields of legislative authority which is common to both. 
...
##### Mr ROBERTON:<br><small class="text-muted">Minister for Socal Services &middot; Riverina &middot; CP</small>
