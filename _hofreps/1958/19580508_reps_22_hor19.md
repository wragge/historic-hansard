...
3. whether the applicant or proposed assignee is a returned  *soldier-* 

There, the term used was that adopted after the first world war, and has not yet been amended - and 

{: type="a" start="e"}
0. any other matters which he thinks fit . . . 
...
{: type="i" start="1"}
0. . this question has not been overlooked. 
...
<graphic href="019131195805083_91_0.jpg"></graphic>
...
{: type="a" start="a"}
0. an amount is expended by an affiliated residential college during a year to which this Part applies... 

Obviously that includes this calendar year, 1958-  on the purchase, erection or alteration of a building of the college; . . . and 

{: type="a" start="b"}
0. the State requests the Commonwealth to grant financial assistance under this section in respect of that expenditure, there is payable to that State . . . one-half of the amount so expended . . . 
