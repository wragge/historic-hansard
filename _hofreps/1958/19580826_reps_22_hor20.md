...
{: type="i" start="1"}
0. . i  rather envy the easy way in which he- 
...
{: type="i" start="1"}
0. . determining the number of scholarships which should be offered in the immediate future. 
