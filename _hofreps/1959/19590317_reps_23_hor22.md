...
{: type="1" start="1"}
0. A hypothetical fear by private banks that the central bank may in the future discriminate against them. 
1. A need to separate all units under the Commonwealth Bank and place them in different compartments. 
2. The establishment of a new Development Bank which will allegedly greatly assist primary producers and businessmen. 
