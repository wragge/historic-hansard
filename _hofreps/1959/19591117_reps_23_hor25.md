...
{: type="i" start="1"}
0. . a petition . . . may be based on one or more of the following grounds: - 
...
{: type="1" start="5"}
0. -- (1.) In this Act, unless the contrary intention appears - " Australia " includes Norfolk Island; " crime " means an offence punishable by imprisonment; " decree " means decree, judgment or order, and includes a decree nisi and an order dismissing a petition or application; " Matrimonial cause " means - 

    {: type="a" start="a"}
    0. proceedings for a decree of - 

    {: type="i" start="i"}
    0. dissolution of marriage; 
    1. nullity of marriage; 
    2. judicial separation; 
    3. restitution of conjugal rights; or 
    4. jactitation of marriage; 

    1. proceedings for a declaration of the validity of a decree of dissolution or nullity of marriage or of judicial separation, or for a declaration of the continued operation of a decree of judicial separation, or for an order discharging a decree of judicial separation; 
