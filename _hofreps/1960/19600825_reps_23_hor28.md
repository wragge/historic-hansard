...
{: type="i" start="1"}
0. . When a Commonwealth government frames its budget, it must, above all, try to ensure that it serves the paramount common purposes. 
...
{: type="i" start="1"}
0. . it has been remarkably continuous. It has gone forward, seldom faltering, on a strong current of energy and initiative. There have been times when it has required some temporary stimulus . . . 
