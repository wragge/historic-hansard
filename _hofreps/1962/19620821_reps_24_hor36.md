...
{: type="i" start="1"}
0. . in view of the geographical features of localities and other circumstances connected with the division and delimitation of boundaries. 
...
{:#subdebate-29-1}
#### Practices - Australian Economy - Wheat
...
{: type="1" start="2"}
0. What was the average price paid for wheat in each of these years? 3. What amount is still owing by China on these purchases? 4. Have any future sales been negotiated; if so, what are the details? 
