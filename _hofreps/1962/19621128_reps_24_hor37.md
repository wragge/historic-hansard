...
{: type="i" start="1"}
0. . to purchase, or to take on lease or charter, ships required for carrying on the business of the commission; 
...
{: type="1" start="1"}
0. How many ships made up the first Commonwealth Shipping Line? 
1. For what amount were these ships sold? 
2. How much did the Commonwealth actually receive for these ships? 
...
{: type="a" start="b"}
0. the names and places of business of the persons to whom licences in respect of goods of that class were granted during the period to which the notice relates; and 
1. the total value of ali the goods covered by the licences to which the notice relates. 
