...
{: type="a" start="b"}
0. The State need for a Medical School in Hobart is an urgent one in its own right, and docs not depend for support on student enrolment from mainland States. 
...
{:#debate-36}
### WHEAT INDUSTRY STABILIZATION BULL 1963
...
{: type="1" start="1"}
0. Period of plan: Five years to apply to the crops of 1963-64 to 1967-68. 
1. Australian Wheat Board: To be the sole constituted authority for the marketing of wheat within Australia and for the marketing of wheat and Hour for export from Australia. 
2. Commonwealth guarantee: The guaran teed price will apply to 150,000,000 bushels of export wheat for the five years of the plan. In the first year the guaranteed price will be 14s. 5d. per bushel bulk basis f .o.r. ports to be adjusted in succeeding years according to movements in production costs. 
3. Stabilization fund: To be collected by means of an export tax equal to the excess of export returns over the guaranteed return with a maximum tax of ls. 6d. per bushel. The stabilization fund is the growers' contribution towards financing the guarantee. 
4. Size of fund: A ceiling of £30,000,000 will apply during the new scheme compared with the present £20,000,000. 
5. Home consumption price: This will be fixed by State legislation and be based on the guaranteed price. 
6. Freight to Tasmania: A loading will be continued on the price of all wheat sold for consumption in Australia to cover the cost of transporting wheat from the mainland to Tasmania each season. The present loading is Hd. per bushel. 
7. Premium on Western Australian wheat: 
...
{: type="a" start="a"}
0. Large scale irrigated production in reasonably compact areas, with suitable soils and climate; 
1. Ginneries located within or close to growing areas; 
2. Adequate transport facilities; and 
3. Adequate research facilities. 
...
{: type="a" start="a"}
0. The level of assistance which might be given should be such as to induce the very heavy initial investment required in the more favoured areas; 
1. It should be such, and for a sufficiently long period, to enable the currently less favoured areas in Queensland to adapt to new conditions. 
2. The ultimate aim of any assistance should be to promote a selfcontained and economic industry. 
...
{: type="a" start="a"}
0. Bounty payments on a seed cotton basis give no encouragement to the production of seed cotton which yields a high raw cotton content; 
1. The practice of individual freight and ginning costs being an allowable charge before determination of bounty, encourages the dispersal of the growing industry remote from ginneries and offers no particular encouragement for ginning efficiency; and 
2. The payment of bounty on a flat rate per lb. of cotton gives no encouragement for the production of higher quality cotton. 
...
{: type="A" start="I"}
0. now want to make the point that the Commonwealth Committee on Taxation used the term " logging areas ". I suggest that at times definitions can bc very difficult indeed. Some of us, in association with other people outside the Parliament, have put in considerable efforts to try to change the term that is used. The Government has found it necessary to accept the term " logging areas " generally as it was used by the Commonwealth Committee on Taxation. But may I point out that, very wisely indeed, the Government has provided, in the Income Tax and Social Services Contribution Assessment Bill that we arc considering, a definition that contains the expression " in a forest and in or adjacent to the area where timber milled is or is to bc felled". The explanatory notes that have been circulated tell us, at page 72, that three tests are to be applied in determining entitlement to the deduction of expenditure on certain mill buildings and housing for employees. The third test mentioned is that, in order to qualify, a building shall be located in a forest and either in, or adjacent to, the area where the timber being milled is felled. The question of whether a building is situated in a forest or in or adjacent to the area where the timber being milled is felled will have to be determined in the light of the facts of each case. Any decision by the Commissioner of Taxation on these matters will be subject to the usual rights of objection and appeal. 
...
{: type="i" start="1"}
0. . situated in a forest and in or adjacent to the area where timber milled in the course of that business is or is to be felled. 
...
{: type="a" start="a"}
0. a number equal to the number of whole years, as at the end of that year of income, in the estimated period during which the building will be used for the purpose for which it was primarily and principally constructed or purchased; or 
1. twenty-five, whichever number is the less.  " (3.) For the purposes of this section, the residual capital expenditure in respect of a building shall be ascertained by deducting from the amount of expenditure specified in sub-section (1.) of this section incurred in respect of the building any part of that expenditure that has been allowed or is allowable as a deduction under this section from the assessable income of a year of income before the year of income. 
