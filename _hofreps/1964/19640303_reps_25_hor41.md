...
* [QUESTION](#debate-19)
    * [WILLIAMSTOWN RIFLE RANGE](#subdebate-19-0)
* [QUESTION](#debate-20)
...
{: type="i" start="1"}
0. . without armed struggle there will be no place for the proletariat, there will be no place for the people, there will be no Communist Party and there will be no victory in revolution. 
...
{: type="1" start="1"}
0. To study how costs of new and projected enterprises can be reduced (i) by improved techniques and reduced transport and power costs and (ii) by increasing the market, domestic and overseas, and hence reducing costs per unit of output. 
1. To study the possibility of circular integration of industries to get "external economies of scale". For example, the co-ordination in the central Queensland area, where unemployment has been as high as 13 per cent., of power stations, coal washing plant, new railways, alumina refineries and fertilizers. 
2. To examine three different paths of development in manufacturing: 

    {: type="a" start="a"}
    0. The expansion of existing products with existing methods; 
    1. The expansion of existing products with new methods, such as a study of Alcan's Canadian experience in producing aluminium from bauxite without the intermediate alumina  stage; 
    2. The introduction of new com modities and the recommendation of the establishment of publicly owned enterprises where private capital is clearly unwilling or too unimaginative to invest. These corporations should be statutory bodies with the right to apply for special grants under section 96 of the Constitution. The sold-out Australian Aluminium Production Commission is an example of this prototype. 

3. A section of the commission should be a northern public finance corporation set up with Government finance but with some debenture shares offered to the public and the State Governments. 
4. A special study should be made of ways of integrating the power industry with new industries by programming the requirements of such industries. A department of the planning commission should be responsible for fuel and power policy and should consult with State electricity commissions and coal boards. In this way, the scandal of the Merz-McLennan report on electrical development in Queensland, based on inadequate data about the relative price of coal at Ipswich and Callide, would be avoided. 
5. The commission should consider these main aspects of development policy for northern Australian projects: 

    {: type="i" start="i"}
    0. Benefit-cost studies - that is, annual value of final output as a ratio to cost; 
    1. Period of recoupment of rival variants of achieving a given output - that is, where there is a varient " A " more expensive on capital but with cheaper operation costs than a project " B " which is cheaper on capital but with higher running costs. Some norms or coefficients should be announced as satisfactory for investment in different sectors; 
    2. A subsidies policy. It will be recalled that this bedevilled the negotiations between the Queensland State Electricity Commission and Comalco over an aluminium refinery which required huge amounts of electricity at less than 0.3 pence per kilowatt hour. The northern development commission could give advice to State Government instrumentalities and to the Commonwealth Government on whether it is desirable that subsidies should take the form of low charges - for example, low coal or electricity prices - which imposes strains on the financial position of State Government instrumentalities or whether there should be clear, earmarked financial grants to new enterprises from State or Commonwealth Governments. 

6. The geographical location of industry should be selected on the basis of the best economics - for example, rival claims of Weipa and Gove bauxite development. 
...
<graphic href="041131196403032_57_1.jpg"></graphic>
...
{:#debate-34}
### BULLS RETURNED FROM THE SENATE

The following bills were returned from the Senate without amendment: - 

{:#subdebate-34-0}
#### Ministers of State Bill 1964. Public Service Bill 1964
