...
-- I desire to address a question to the Treasurer. Can he inform the House why Hawkesbury River has "been excluded from the New South Wales Grant (Flood Mitigation) Bill 1964, which is presently before the House? 
...
##### Mr DEPUTY SPEAK KR:<br><small class="text-muted">Mr. Lucock</small>
...
{: type="a" start="a"}
0. Congratulate those sections of the Labor 
...
{: type="a" start="b"}
0. In order that the menace of the Com munist Party might be understood by all, we recommend to the Executive that it prepare and issue a report on the working and policies of the Communist Party in Australia. 
