...
{: type="a" start="b"}
0. the payment of child endowment for the first child at the rate of 10s. a week. 
...
{: type="a" start="c"}
0. a substantial increase in unemployment and sickness benefits; 
1. further amelioration of the means test. 
...
{: type="1" start="2"}
0. the rates set out in the bill to be further increased to meet the increased cost of living; 
1. the means test to be liberalized in the light of the change in money values 
...
{: type="1" start="2"}
0. the rates set out in the bill to be further increased to the same percentage of the basic wage as before this Government took office; 
1. the amounts of permissible income and permissible property under the means test to be further increased in accord with the change in money values; 
2. similarly appropriate increases to be made in those social service rates which have not been so increased. 
...
{: type="i" start="1"}
0. . this House is of the opinion that - 
1. increases should be made in - 
2. child endowment which has remained unchanged for the first child for thirteen years and for subsequent children for fifteen years. 
