...
{: type="i" start="1"}
0. . proposes to reintroduce a tax on new tubes. If the tax were in line with the tax charged on the set, then it too would be  25  per cent.- 

That being the rate of sales tax applicable at present to a new television set, with the exception of the picture tube - 

{: type="i" start="1"}
0. . and on the basis of recent wholesale prices of picture tubes, would yield the government just under  £5  on each twenty-three inch tube. In other words, the loss in annual revenue of roughly  £1.9  million predicted in the Budget would amount to only£300,000 to  £400,000  at most. 
...
{: type="i" start="1"}
0. . this League of Arab States is not an official organisation. It has no international standing and is not recognised internationally in any way. It is a private organisation . . . 
